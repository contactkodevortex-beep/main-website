import { Facebook, X, Instagram, Linkedin, Youtube, Github } from 'lucide-react';

const socialLinks = [
  { Icon: Facebook, color: '#1877F2', href: '#', name: 'Facebook' },
  { Icon: X, color: '#ffffff', href: 'https://x.com/kodeVortex', name: 'X' },
  { Icon: Instagram, color: '#E4405F', href: 'https://www.instagram.com/kodevortex/', name: 'Instagram' },
  { Icon: Linkedin, color: '#0A66C2', href: 'https://www.linkedin.com/company/kodevortex', name: 'LinkedIn' },
  { Icon: Youtube, color: '#FF0000', href: 'https://www.youtube.com/channel/UC6lPbeFdE9vQxhwfIroUYDg', name: 'YouTube' },
